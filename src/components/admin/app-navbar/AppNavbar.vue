  ...
  >
    <div class="app-navbar__content row">
      <div class="app-navbar__menu-container">
        ...
        <router-link
          class="app-navbar__logo mr-5"
          to="/"
        >
          <!--          <va-icon-vuestic />-->
          <!--          <img src="../../../assets/icons/logo_v2.png" alt="" style="width: 50px;">-->
          <img src="../../../assets/icons/title_v2.png" alt="Title logo" style="height: 30px; vertical-align: center;">
        </router-link>
