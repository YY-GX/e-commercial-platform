<template>
  <div class="cards">
    ...
    <div>
      <wishlist-item :image-url="imageUrl" :name="title" :price="id" :wish-list-id="id" :product-id="id"></wishlist-item>
    </div>

    <div>
      <my-cube :image-url="imageUrl" :title="title" :intro="intro" :type="brand" :id="id"></my-cube>
    </div>
...
<script>
  import MyCube from "../../myComponents/myCube";
  import WishlistItem from "../../myComponents/wishlistItem";
  import VaSocialNews from "vuestic-ui/src/components/vuestic-components/va-social-news/VaSocialNews";
export default {
  name: 'cards',
  components: {VaSocialNews, WishlistItem, MyCube},
  data () {
    return {
      listLoops: 1,
      counter: 1,
