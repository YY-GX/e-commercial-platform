...
var JSDOMEnvironment = /** @class */ (function () {
    function JSDOMEnvironment(config, options) {
        ...
        var resourceLoader = new jsdom_1.ResourceLoader(config.testEnvironmentOptions);
        this.dom = new jsdom_1.JSDOM("<!DOCTYPE html>", __assign({ pretendToBeVisual: true, runScripts: "dangerously", url: config.testURL, virtualConsole: new jsdom_1.VirtualConsole().sendTo(options.console || console), resources: resourceLoader }, config.testEnvironmentOptions));
